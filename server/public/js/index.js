...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _practice = __webpack_require__(329);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // 兼容模块
	...
	var Practice = function (_mix2) {
	  _inherits(Practice, _mix2);
	  ...
	  function Practice() {
	    ...
	    var cnname = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '11选5';
	    var issue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '**';
	    var state = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '**';

	    _classCallCheck(this, Practice);

	    var _this = _possibleConstructorReturn(this, (Practice.__proto__ || Object.getPrototypeOf(Practice)).call(this));
	    // 继承时 super 要放在最前面
	  ...
	  _createClass(Practice, [{
	    ...
	    value: function initEvent() {
	      ...
	      // 号码
	      (0, _jquery2.default)('.boll-list').on('click', '.btn-boll', self.toggleCodeActive.bind(this));
	  ...
	  _createClass(Timer, [{
	    ...
	    value: function countDown(end, update, handle) {
	      ...
	      if (now - end) {
	        ...
	        // 剩余小时
	        var h = Math.floor(left_time / px_h);
	        left_time = left_time - h * px_h;
	        // 剩余分钟
	        var m = Math.floor(left_time / px_m);
	        left_time = left_time - m * px_m;
	        // 剩余秒
	        var s = Math.floor(left_time / px_s);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // 引入 jquery 库  因为封装了很多方法 且最流行
