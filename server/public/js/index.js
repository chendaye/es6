...
/***/ (function(module, exports) {
...

	{
	  ...
	  var regex3 = new RegExp(/xyz/ig, 'i'); // 第二个参数 i 会覆盖 ig
...

	{
	  ...
	  console.log('u-2', /^(?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])$/.test(str)); //true


	  console.log('u-3', /^𠮷{2}/.test('𠮷𠮷')); //false
	  console.log('u-6', /^(?:\uD842\uDFB7){2}/.test('𠮷𠮷')); //true
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(10), 'Object', { defineProperties: __webpack_require__(50) });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  function (test, buggy, set) {
	    try {
	      set = __webpack_require__(24)(Function.call, __webpack_require__(54).f(Object.prototype, '__proto__').set, 2);
	      set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !__webpack_require__(11)(function () {
	  // V8 ~ Android 4.3-
	  $toFixed.call({});
	})), 'Number', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10) && $export($export.P + __webpack_require__(276), 'Object', {
